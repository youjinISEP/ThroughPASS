...
object Prop {
    ...
    /* 1. 티켓 등록 화면 : 티켓 번호 - > 서버 */
    data class RegistTicketData(val ticketCode : String, val nfcUid : String)   //REQ DATA
    ...
    /* 11. NFC 태깅 진행 */
    data class TagNFC(val nfcUid: String, val attrCode : Int)
    data class TagNFCResultData(var result: String)
